...
#### 🏦 AI Recruitment & Onboarding Assistant *(Hack CX in Banking Together 2026)*
`LLMs` `Agents` `Automation`
AI Agent-based recruitment assistant for banking HR workflows, featuring CV analysis, virtual interview simulation, an HR chatbot, and end-to-end workflow automation. **Top 6 out of 86 teams.**
